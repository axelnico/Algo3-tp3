...
arr = np.loadtxt("salida_nuevos_random.data", delimiter=',')
...
pylab.plot(nm, promedio1NP,'ro', label= 'Resultado de Instancias Random')
# pylab.plot(deAUno, grafCota,color='black', marker='s', label= 'Cota de Complejidad')


ax1.set_title("Tiempo en función de cantidad de estaciones")
ax1.set_xlabel('Cantidad de estaciones')
