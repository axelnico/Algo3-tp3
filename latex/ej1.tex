...
fin BT_capturar_gimnasios
    ...
    \subsection{Experimentación}
      ...
      \begin{itemize}
        \item Casos generales para analizar el comportamiento de las podas
        \item Casos particulares para analizar el algoritmo con distintas configuraciones de valores que no están en la cota de complejidad
